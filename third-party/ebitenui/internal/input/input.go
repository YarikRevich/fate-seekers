...
func (handler *DefaultInternalHandler) Update() {
	...
	if handler.isTouched {
		...
		if external.GetExternalLeftMouseClick() != nil {
			handler.LeftMouseButtonPressed = external.GetExternalLeftMouseClick()()
		} else {
			handler.LeftMouseButtonPressed = ebiten.IsMouseButtonPressed(ebiten.MouseButtonLeft)
		}

		if external.GetExternalRightMouseClick() != nil {
			handler.RightMouseButtonPressed = external.GetExternalRightMouseClick()()
		} else {
			handler.RightMouseButtonPressed = ebiten.IsMouseButtonPressed(ebiten.MouseButtonRight)
		}

		if external.GetExternalMiddleMouseClick() != nil {
			handler.MiddleMouseButtonPressed = external.GetExternalMiddleMouseClick()()
		} else {
		...
		if external.GetExternalCursorPositionSource() != nil {
			handler.CursorX, handler.CursorY = external.GetExternalCursorPositionSource()()
		} else {
	...
	if external.GetExternalWheelMouse() != nil {
		wx, wy = external.GetExternalWheelMouse()()
	} else {
		wx, wy = ebiten.Wheel()
	}
