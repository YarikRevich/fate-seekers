...
func (r *Runtime) Update() error {
	...
	if ebiten.IsKeyPressed(ebiten.KeyQ) {
		if r.camera.ZoomFactor > -2400 {
			r.camera.ZoomFactor -= 1
		}
	}
...
func (r *Runtime) Draw(screen *ebiten.Image) {
	...
	// 	}
	// }
	r.world.DrawImage(loader.GetInstance().GetObject("test.png"), &ebiten.DrawImageOptions{})

	r.camera.Render(r.world, screen)
